...
test('kepler-outdated-luma.gl-constants', t => {
  t.equal(typeof GL, 'object', 'kepler-outdated-luma.gl-constants is an object');
  t.end();
});

test('kepler-outdated-luma.gl-constants#WebGL1 context', t => {
  const count = checkConstants(fixture.gl, t);
  t.comment(`Checked ${count} GL constants against platform WebGL1 context`);
  t.end();
});

test('kepler-outdated-luma.gl-constants#WebGL2 context', t => {
